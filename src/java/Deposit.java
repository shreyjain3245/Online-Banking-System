            ...
            if(found1!=true)
             {
                ...
                String s7=Integer.toString((Integer.parseInt(s3)+Integer.parseInt(amount))); 
                ps2.setString(2,s2);
                ps2.setString(1,s7);
                ps3.setString(1,s1);
                ps3.setString(2,s2);
                ...
                out.println("<script type=\"text/javascript\">");
                out.println("alert('Deposit Succesful');");
                out.println("location='Home.jsp';");
                out.print("</script>");
            }
        }catch(Exception e){   
                out.println("<script type=\"text/javascript\">");
                out.println("alert('Problem In Depositing Money, Try Again Later');");
                out.println("location='Deposit.jsp';");
                out.print("</script>");
        }
    }
